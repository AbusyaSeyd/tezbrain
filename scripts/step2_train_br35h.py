...
from src import Br35HDataset, BrainTumorGNN
...
def train_full_model():
    ...
    try:
        data_root = os.path.join(DATA_ROOT, 'br35h')
        train_dataset = Br35HDataset(root=data_root, split='train', n_segments=100)
        test_dataset = Br35HDataset(root=data_root, split='test', n_segments=100)
