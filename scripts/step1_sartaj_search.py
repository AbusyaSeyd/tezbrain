...
from src import SartajDataset, BrainTumorGNN, prepare_artifact_dirs
...
def main() -> None:
    ...
    parser.add_argument("--data_root", type=str, default="data", help="Path containing the 'sartaj' folder")
